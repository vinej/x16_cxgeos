#!/usr/bin/env python3
"""prog8.py -- generate the Prog8 binding for the CXGEOS ABI.
...
CXGEOS jump table ($8010 + slot*3), where args ride A/X/Y and returns come back
...
def gen(version, slots):
    """Return the Prog8 binding sdk/include_prog8/cxgeos.p8."""
    a = {s["name"]: addr(s["slot"]) for s in slots}
    L = ["; Prog8 -- GENERATED by abi/gen_bindings.py. Do not edit."]
    L.append("; =====================================================================")
    L.append("; CXGEOS ABI version %d -- Prog8 binding" % version)
    L.append("; =====================================================================")
    ...
    L.append("; no_sysinit: a CXGEOS app is a GUEST -- the kernel owns the machine.")
    ...
    L.append(";")
    L.append("; The CXGEOS kernel owns zero page $02..$5F and clobbers it across every")
...
if __name__ == "__main__":
    import gen_bindings
    v, sl = gen_bindings.parse((Path(__file__).resolve().parent / "cxgeos.abi").read_text(encoding="ascii"))
