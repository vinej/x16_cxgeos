...
; --- the graphics port -------------------------------------------
    jmp cx_do_gfx_mode   ; 76  A = the mode, X = bpp (0/2/4/8; 0 = the mode's native depth) -> carry set if unknown; swaps the engine and runs its init (VERA is reprogrammed, the screen is the new mode's). Mode 1 (320x240) is 8/4/2 bpp; mode 4 (640x480, VERA_2) is 8/4 bpp; for mode 2 (tiles) X sets the default tile depth cx_tile_setup adopts when its own bpp is 0; X is ignored for modes 0/3
